...
define('TXT_LOAD_INSTRUCTION_2', "Beladen Datei :");
...
define('TXT_INSTAL_TXT', "Um dieses Interface zu verwenden, müssen Sie: <br />
			...
			Wenn Sie regEfmtool aus einem anderen Ordner verwenden möchten, müssen Sie die Datei-Pfade im Programmcode zu ändern.<br />
			- Über diese Schnittstelle werden alle Dateien, die mit Zugang zu einem Web-Server (Apache oder andere) muss installiert sein.");
