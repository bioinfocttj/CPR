...
Nous avons également ajouté un lien vers une page contenant le \textit{copyright} de notre site, et un autre menant à une page de précisions sur la configuration requise à l'utilisation de l'interface. 
