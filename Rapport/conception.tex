...
La page d'extraction des résultats offre à l'utilisateur la possibilité de visualiser l'ensemble des résultats générés par regEfmtool ou de pouvoir en extraire une partie à l'aide d'un mot clé sélectionné dans un menu déroulant (Figure \ref{rechercheLog}).
