...
Dans le cadre de l'UE Conception d'un Projet de Recherche du Master 2 BioInformatique, notre but était de réaliser une interface graphique (en langages Web) afin de pallier au manque d'ergonomie de \textit{regEfmtool}. Puisque jusqu'à présent aucune méthode ne permet de générer les fichiers d'entrée de ce logiciel, ni de le lancer sans ligne de commande.\\
